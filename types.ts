...
export interface User {
  ...
  // NEW: Season/Syllabus Tracking
  syllabusProgress?: StudentSyllabusProgress;
  mcqHistory?: McqAttemptLog[];
}

export interface SyllabusMonth {
  monthNumber: number; // 1-12
  title: string; // "MONTH 1 (Day 1–30) – FOUNDATION START"
  subjects: {
...
export interface StudentSyllabusProgress {
  completedChapters: string[]; // List of chapter names completed
}

export interface McqAttemptLog {
  id: string;
  chapterTitle: string;
  subjectName: string;
  score: number;
...
export interface SystemSettings {
  ...
  // SYLLABUS STRUCTURE
  syllabusData?: Record<string, SyllabusStructure>; // Key: ClassLevel
  sessionStartDate?: string; // ISO String
}
