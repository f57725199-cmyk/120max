...
export const SYLLABUS_STRUCTURE_DEFAULTS: Record<string, SyllabusStructure> = {
  "9": {
    classLevel: '9',
    months: [
      { monthNumber: 1, title: "MONTH 1 – FOUNDATION START", subjects: [
          { subject: "Mathematics", chapters: ["Number Systems", "Polynomials"] },
          { subject: "Science", chapters: ["Motion", "Matter in Our Surroundings", "The Fundamental Unit of Life"] },
          { subject: "Social Science", chapters: ["The French Revolution", "India – Size and Location", "What is Democracy? Why Democracy?", "The Story of Village Palampur"] }
      ]},
      { monthNumber: 2, title: "MONTH 2", subjects: [
          { subject: "Mathematics", chapters: ["Polynomials", "Linear Equations in Two Variables"] },
          { subject: "Science", chapters: ["Force and Laws of Motion", "Is Matter Around Us Pure", "Tissues"] },
          { subject: "Social Science", chapters: ["Socialism in Europe and the Russian Revolution", "Physical Features of India", "Constitutional Design", "People as Resource"] }
      ]},
      { monthNumber: 3, title: "MONTH 3", subjects: [
          { subject: "Mathematics", chapters: ["Linear Equations in Two Variables", "Coordinate Geometry"] },
          { subject: "Science", chapters: ["Gravitation", "Atoms and Molecules", "Diversity in Living Organisms"] },
          { subject: "Social Science", chapters: ["Nazism and the Rise of Hitler", "Drainage", "Electoral Politics", "Poverty as a Challenge"] }
      ]},
      { monthNumber: 4, title: "MONTH 4", subjects: [
          { subject: "Mathematics", chapters: ["Lines and Angles", "Triangles"] },
          { subject: "Science", chapters: ["Work and Energy", "Structure of the Atom", "Why Do We Fall Ill"] },
          { subject: "Social Science", chapters: ["Forest Society and Colonialism", "Climate", "Working of Institutions", "Food Security in India"] }
      ]},
      { monthNumber: 5, title: "MONTH 5", subjects: [
          { subject: "Mathematics", chapters: ["Triangles", "Quadrilaterals"] },
          { subject: "Science", chapters: ["Sound", "Chemical Reactions and Equations", "Natural Resources"] }, // Note: Chemical Reactions is Class 10 topic per prompt
          { subject: "Social Science", chapters: ["Pastoralists in the Modern World", "Natural Vegetation and Wildlife", "Democratic Rights"] }
      ]},
      { monthNumber: 6, title: "MONTH 6 – FIRST REVISION", subjects: [
          { subject: "Mathematics", chapters: ["Circles", "Heron’s Formula"] },
          { subject: "Science", chapters: ["Revision: Physics (Motion-Sound)", "Revision: Chemistry", "Revision: Biology"] },
          { subject: "Social Science", chapters: ["Population", "Revision: SST"] }
      ]},
      { monthNumber: 7, title: "MONTH 7 – SECOND ROUND", subjects: [
          { subject: "Mathematics", chapters: ["Surface Areas and Volumes", "Statistics"] },
          { subject: "Science", chapters: ["Numericals Practice", "Diagrams & Definitions"] },
          { subject: "Social Science", chapters: ["Answer Writing Practice", "Maps Practice"] }
      ]},
      { monthNumber: 8, title: "MONTH 8", subjects: [
          { subject: "Mathematics", chapters: ["Probability", "Full Revision R1"] },
          { subject: "Science", chapters: ["Physics Numericals", "Chemistry Reactions", "Biology Diagrams"] },
          { subject: "Social Science", chapters: ["Civics & Economics Revision"] }
      ]},
      { monthNumber: 9, title: "MONTH 9", subjects: [
          { subject: "Mathematics", chapters: ["Sample Papers", "Weak Areas"] },
          { subject: "Science", chapters: ["Case-based Questions", "Assertion-Reason"] },
          { subject: "Social Science", chapters: ["Long Answer Practice", "Maps Daily"] }
      ]},
      { monthNumber: 10, title: "MONTH 10", subjects: [
          { subject: "All", chapters: ["Full Syllabus Revision R2", "Weekly Tests"] }
      ]},
      { monthNumber: 11, title: "MONTH 11 – EXAM MODE", subjects: [
          { subject: "All", chapters: ["Sample Papers", "Mock Tests", "Time Management"] }
      ]},
      { monthNumber: 12, title: "MONTH 12 – FINAL POLISH", subjects: [
          { subject: "All", chapters: ["Formula Revision", "Important Questions", "Diagrams & Maps"] }
      ]}
    ]
  },
  "10": {
    classLevel: '10',
    months: [
      { monthNumber: 1, title: "MONTH 1 – BOARD FOUNDATION", subjects: [
          { subject: "Mathematics", chapters: ["Real Numbers", "Polynomials"] },
          { subject: "Science", chapters: ["Light – Reflection and Refraction", "Chemical Reactions and Equations", "Life Processes"] },
          { subject: "Social Science", chapters: ["The Rise of Nationalism in Europe", "Power Sharing", "Resources and Development", "Development"] }
      ]},
      { monthNumber: 2, title: "MONTH 2", subjects: [
          { subject: "Mathematics", chapters: ["Pair of Linear Equations in Two Variables"] },
          { subject: "Science", chapters: ["Light – Reflection and Refraction", "Acids, Bases and Salts", "Life Processes"] },
          { subject: "Social Science", chapters: ["Nationalism in India", "Federalism", "Agriculture", "Sectors of the Indian Economy"] }
      ]},
      { monthNumber: 3, title: "MONTH 3", subjects: [
          { subject: "Mathematics", chapters: ["Quadratic Equations"] },
          { subject: "Science", chapters: ["The Human Eye and the Colourful World", "Metals and Non-Metals", "Control and Coordination"] },
          { subject: "Social Science", chapters: ["The Making of a Global World", "Gender, Religion and Caste", "Water Resources", "Money and Credit"] }
      ]},
      { monthNumber: 4, title: "MONTH 4", subjects: [
          { subject: "Mathematics", chapters: ["Arithmetic Progressions"] },
          { subject: "Science", chapters: ["Electricity", "Carbon and its Compounds", "How do Organisms Reproduce?"] },
          { subject: "Social Science", chapters: ["The Age of Industrialisation", "Political Parties", "Minerals and Energy Resources", "Globalisation and the Indian Economy"] }
      ]},
      { monthNumber: 5, title: "MONTH 5", subjects: [
          { subject: "Mathematics", chapters: ["Triangles", "Coordinate Geometry"] },
          { subject: "Science", chapters: ["Magnetic Effects of Electric Current", "Carbon and its Compounds", "Heredity and Evolution"] },
          { subject: "Social Science", chapters: ["Print Culture and the Modern World", "Manufacturing Industries", "Civics Revision"] }
      ]},
      { monthNumber: 6, title: "MONTH 6 – FIRST REVISION", subjects: [
          { subject: "Mathematics", chapters: ["Introduction to Trigonometry", "Trigonometric Identities"] },
          { subject: "Science", chapters: ["Physics Revision", "Chemistry Revision", "Biology Revision"] },
          { subject: "Social Science", chapters: ["Lifelines of National Economy", "Full SST Revision"] }
      ]},
      { monthNumber: 7, title: "MONTH 7 – SECOND ROUND", subjects: [
          { subject: "Mathematics", chapters: ["Some Applications of Trigonometry", "Circles"] },
          { subject: "Science", chapters: ["Numericals & Derivations", "Diagrams Practice"] },
          { subject: "Social Science", chapters: ["Answer Writing", "Maps Practice"] }
      ]},
      { monthNumber: 8, title: "MONTH 8", subjects: [
          { subject: "Mathematics", chapters: ["Constructions", "Areas Related to Circles"] }, // Constructions removed in new NCERT but keeping per prompt
          { subject: "Science", chapters: ["Case Study Questions", "Assertion-Reason"] },
          { subject: "Social Science", chapters: ["Civics & Eco Revision", "Long Answers"] }
      ]},
      { monthNumber: 9, title: "MONTH 9", subjects: [
          { subject: "Mathematics", chapters: ["Surface Areas and Volumes", "Statistics", "Probability"] },
          { subject: "Science", chapters: ["PYQ Numericals", "Chemistry Reactions Drill"] },
          { subject: "Social Science", chapters: ["PYQ Practice", "Maps & Timelines"] }
      ]},
      { monthNumber: 10, title: "MONTH 10", subjects: [
          { subject: "All", chapters: ["Full Syllabus Revision R2", "Weekly Tests"] }
      ]},
      { monthNumber: 11, title: "MONTH 11 – PRE-BOARD", subjects: [
          { subject: "All", chapters: ["Full Sample Papers", "Time Bound Tests", "Presentation"] }
      ]},
      { monthNumber: 12, title: "MONTH 12 – FINAL MODE", subjects: [
          { subject: "All", chapters: ["Formula Sheets", "Important Questions", "Diagrams & Maps"] }
      ]}
    ]
  },
  "11": {
    classLevel: '11',
    months: [
      { monthNumber: 1, title: "MONTH 1", subjects: [
          { subject: "Physics", chapters: ["Physical World", "Units and Measurements"] },
          { subject: "Chemistry", chapters: ["Some Basic Concepts of Chemistry", "Structure of Atom"] },
          { subject: "Mathematics", chapters: ["Sets", "Relations and Functions"] }
      ]},
      { monthNumber: 2, title: "MONTH 2", subjects: [
          { subject: "Physics", chapters: ["Motion in a Straight Line"] },
          { subject: "Chemistry", chapters: ["Structure of Atom"] },
          { subject: "Mathematics", chapters: ["Trigonometric Functions"] }
      ]},
      { monthNumber: 3, title: "MONTH 3", subjects: [
          { subject: "Physics", chapters: ["Motion in a Plane"] },
          { subject: "Chemistry", chapters: ["Classification of Elements and Periodicity in Properties"] },
          { subject: "Mathematics", chapters: ["Trigonometric Equations"] }
      ]},
      { monthNumber: 4, title: "MONTH 4", subjects: [
          { subject: "Physics", chapters: ["Laws of Motion"] },
          { subject: "Chemistry", chapters: ["Chemical Bonding and Molecular Structure"] },
          { subject: "Mathematics", chapters: ["Complex Numbers and Quadratic Equations"] }
      ]},
      { monthNumber: 5, title: "MONTH 5", subjects: [
          { subject: "Physics", chapters: ["Work, Energy and Power"] },
          { subject: "Chemistry", chapters: ["States of Matter"] },
          { subject: "Mathematics", chapters: ["Linear Inequalities", "Permutations and Combinations"] }
      ]},
      { monthNumber: 6, title: "MONTH 6 – REVISION", subjects: [
          { subject: "Physics", chapters: ["System of Particles and Rotational Motion"] },
          { subject: "Chemistry", chapters: ["Thermodynamics"] },
          { subject: "Mathematics", chapters: ["Binomial Theorem", "Sequences and Series"] }
      ]},
      { monthNumber: 7, title: "MONTH 7", subjects: [
          { subject: "Physics", chapters: ["Gravitation"] },
          { subject: "Chemistry", chapters: ["Equilibrium"] },
          { subject: "Mathematics", chapters: ["Straight Lines"] }
      ]},
      { monthNumber: 8, title: "MONTH 8", subjects: [
          { subject: "Physics", chapters: ["Mechanical Properties of Solids"] },
          { subject: "Chemistry", chapters: ["Redox Reactions"] },
          { subject: "Mathematics", chapters: ["Conic Sections"] }
      ]},
      { monthNumber: 9, title: "MONTH 9", subjects: [
          { subject: "Physics", chapters: ["Mechanical Properties of Fluids"] },
          { subject: "Chemistry", chapters: ["Hydrogen"] },
          { subject: "Mathematics", chapters: ["Introduction to Three Dimensional Geometry"] }
      ]},
      { monthNumber: 10, title: "MONTH 10", subjects: [
          { subject: "Physics", chapters: ["Thermal Properties of Matter"] },
          { subject: "Chemistry", chapters: ["The s-Block Elements"] },
          { subject: "Mathematics", chapters: ["Limits and Derivatives"] }
      ]},
      { monthNumber: 11, title: "MONTH 11", subjects: [
          { subject: "Physics", chapters: ["Thermodynamics"] },
          { subject: "Chemistry", chapters: ["Organic Chemistry – Some Basic Principles and Techniques", "Hydrocarbons"] },
          { subject: "Mathematics", chapters: ["Mathematical Reasoning", "Statistics"] }
      ]},
      { monthNumber: 12, title: "MONTH 12", subjects: [
          { subject: "Physics", chapters: ["Oscillations", "Waves"] },
          { subject: "Chemistry", chapters: ["Hydrocarbons", "Environmental Chemistry"] },
          { subject: "Mathematics", chapters: ["Probability", "Full Revision"] }
      ]}
    ]
  },
  "12": {
    classLevel: '12',
    months: [
      { monthNumber: 1, title: "MONTH 1 – ELECTRIC START", subjects: [
          { subject: "Physics", chapters: ["Electric Charges and Fields", "Electrostatic Potential and Capacitance"] },
          { subject: "Chemistry", chapters: ["The Solid State", "Solutions"] },
          { subject: "Mathematics", chapters: ["Relations and Functions", "Inverse Trigonometric Functions"] }
      ]},
      { monthNumber: 2, title: "MONTH 2", subjects: [
          { subject: "Physics", chapters: ["Current Electricity"] },
          { subject: "Chemistry", chapters: ["Electrochemistry"] },
          { subject: "Mathematics", chapters: ["Matrices", "Determinants"] }
      ]},
      { monthNumber: 3, title: "MONTH 3", subjects: [
          { subject: "Physics", chapters: ["Moving Charges and Magnetism"] },
          { subject: "Chemistry", chapters: ["Chemical Kinetics", "Surface Chemistry"] },
          { subject: "Mathematics", chapters: ["Continuity and Differentiability"] }
      ]},
      { monthNumber: 4, title: "MONTH 4", subjects: [
          { subject: "Physics", chapters: ["Magnetism and Matter", "Electromagnetic Induction"] },
          { subject: "Chemistry", chapters: ["General Principles and Processes of Isolation of Elements"] },
          { subject: "Mathematics", chapters: ["Application of Derivatives"] }
      ]},
      { monthNumber: 5, title: "MONTH 5", subjects: [
          { subject: "Physics", chapters: ["Alternating Current"] },
          { subject: "Chemistry", chapters: ["The p-Block Elements (Part 1)"] },
          { subject: "Mathematics", chapters: ["Integrals"] }
      ]},
      { monthNumber: 6, title: "MONTH 6 – REVISION", subjects: [
          { subject: "Physics", chapters: ["Electromagnetic Waves", "Ray Optics and Optical Instruments"] },
          { subject: "Chemistry", chapters: ["The p-Block Elements (Part 2)"] },
          { subject: "Mathematics", chapters: ["Application of Integrals", "Differential Equations"] }
      ]},
      { monthNumber: 7, title: "MONTH 7", subjects: [
          { subject: "Physics", chapters: ["Wave Optics"] },
          { subject: "Chemistry", chapters: ["The d- and f- Block Elements"] },
          { subject: "Mathematics", chapters: ["Vector Algebra"] }
      ]},
      { monthNumber: 8, title: "MONTH 8", subjects: [
          { subject: "Physics", chapters: ["Dual Nature of Radiation and Matter"] },
          { subject: "Chemistry", chapters: ["Coordination Compounds"] },
          { subject: "Mathematics", chapters: ["Three Dimensional Geometry"] }
      ]},
      { monthNumber: 9, title: "MONTH 9", subjects: [
          { subject: "Physics", chapters: ["Atoms", "Nuclei"] },
          { subject: "Chemistry", chapters: ["Haloalkanes and Haloarenes"] },
          { subject: "Mathematics", chapters: ["Linear Programming"] }
      ]},
      { monthNumber: 10, title: "MONTH 10", subjects: [
          { subject: "Physics", chapters: ["Semiconductor Electronics", "Communication Systems"] },
          { subject: "Chemistry", chapters: ["Alcohols, Phenols and Ethers"] },
          { subject: "Mathematics", chapters: ["Probability"] }
      ]},
      { monthNumber: 11, title: "MONTH 11 – ORGANIC + REVISION", subjects: [
          { subject: "Physics", chapters: ["Full Physics Revision"] },
          { subject: "Chemistry", chapters: ["Aldehydes, Ketones and Carboxylic Acids", "Amines", "Biomolecules"] },
          { subject: "Mathematics", chapters: ["Full Maths Revision"] }
      ]},
      { monthNumber: 12, title: "MONTH 12 – FINAL MODE", subjects: [
          { subject: "All", chapters: ["NCERT Revision", "Derivations", "Formula Sheets", "Mock Tests"] }
      ]}
    ]
  }
};
